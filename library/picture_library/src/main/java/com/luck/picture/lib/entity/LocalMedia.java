...
public class LocalMedia implements Parcelable {
     ...
     */
    @SerializedName("cropImageWidth")
    private int cropImageWidth;

    /**
     * Crop the height of the picture
     */
    @SerializedName("cropImageHeight")
    ...
    @SerializedName("cropResultAspectRatio")
     ...
     * # For internal use only
     */
    @SerializedName("loadLongImageStatus")
     ...
     * # For internal use only
     */
    @SerializedName("isMaxSelectEnabledMask")
